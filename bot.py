...
MAX_CONCURRENT_ACCOUNTS = 20               # একসাথে কতগুলো 'অ্যাকাউন্ট' চলবে (উদা: ৫টি)
THREADS_PER_ACCOUNT = 40                   # প্রতিটি অ্যাকাউন্টে একসাথে কতগুলো 'বট/কানেকশন' চলবে (উদা: ৪টি)
...
def send_ad_pings(session, url_list, uid, proxy=None):
...
def single_bot_worker(acc_state, proxy_list):
    ...
    while True:
        ...
        try:
            response = session.get(dynamic_gma_url, proxies=proxy, verify=False, timeout=15)
